...
[![Tests](https://img.shields.io/badge/tests-595%20passed-brightgreen.svg)](https://github.com/Boulea7/agy-mcp/actions/workflows/ci.yml)
...
| `agy_sandbox_start` | 啟動內建 local（browser / Android）或已設定的外部遠端 mobile / PC VM sandbox provider，回傳 sandbox_id / endpoint / status |
